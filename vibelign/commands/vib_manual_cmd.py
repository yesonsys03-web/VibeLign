...
MANUAL: dict[str, ManualEntry] = {
    ...
    "rules": {
        ...
        "what": (
            ...
            "  프로젝트 맵과 앵커 규칙이 바뀌면 테스트와 문서도 같이 갱신해요.\n"
            ...
            "  project_map_get → anchor_read_content → 수정 → guard_check → checkpoint 저장\n"
    ...
    "mcp": {
        ...
        "what": (
            ...
            "  project_map_get     — 프로젝트 파일/앵커 지도 보기\n"
            "  anchor_read_content — 선택한 앵커 내용 읽기\n"
