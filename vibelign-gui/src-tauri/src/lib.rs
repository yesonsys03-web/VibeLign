...
struct GuiErrorState(Arc<Mutex<GuiErrorRuntime>>);
...
#[tauri::command]
fn record_gui_error(state: tauri::State<GuiErrorState>, project_dir: String, payload: serde_json::Value) {
...
pub fn run() {
    ...
    let gui_error_inner: Arc<Mutex<GuiErrorRuntime>> = Arc::new(Mutex::new(GuiErrorRuntime::new()));
    ...
    tauri::Builder::default()
        ...
        .manage(GuiErrorState(gui_error_inner))
