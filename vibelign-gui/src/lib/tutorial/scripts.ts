...
const GUESTBOOK: Tutorial = {
  ...
  steps: [
    ...
    { id: "gb-2-send", kind: "pasteSend", say: "기획방 입력칸에 붙여넣고 보내보세요.", why: "AI가 무엇을 만들지 계획을 세워줘요.", target: "planning-compose", goPage: "planning", done: "planResponded" },
...
const QUIZ: Tutorial = {
  ...
  steps: [
    ...
    { id: "qz-2-send", kind: "pasteSend", say: "기획방 입력칸에 붙여넣고 보내보세요.", why: "AI가 무엇을 만들지 계획을 세워줘요.", target: "planning-compose", goPage: "planning", done: "planResponded" },
