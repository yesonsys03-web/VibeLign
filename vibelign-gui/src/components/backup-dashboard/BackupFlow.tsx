...
export default function BackupFlow({ entries }: BackupFlowProps) {
  return (
    <section className="feature-card" style={{ cursor: "default" }}>
      <div className="feature-card-header" style={{ background: "#F0E7FF", padding: "12px 14px" }}>
        <div className="feature-card-icon" style={{ background: "#7B4DFF", borderColor: "#1A1A1A", color: "#fff" }}>🧭</div>
        <div>
          <div style={{ fontWeight: 900, fontSize: 17 }}>저장 흐름</div>
          <div style={{ fontSize: 11, color: "#555" }}>최근 보관 순서를 짧게 보여 줘요.</div>
        </div>
      </div>
