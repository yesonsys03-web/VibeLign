...
cp -R "/Users/topsphinx/YesonENT Dropbox/top sphinx/Mac/Documents/coding/VibeLign/tests/benchmark/sample_project" /tmp/vibelign-ice-sandbox-postC6-ai
...
scenarios = {s["id"]: s for s in json.load(open("/Users/topsphinx/YesonENT Dropbox/top sphinx/Mac/Documents/coding/VibeLign/tests/benchmark/scenarios.json"))}
