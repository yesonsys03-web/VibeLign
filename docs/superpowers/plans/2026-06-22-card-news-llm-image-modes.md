...
- Modify: `vibelign/core/reporting_cli/report_card_news_asset_generator.py` — `_svg_prompt`, `_ASSET_TIMEOUT_SECONDS`.
- Test: 신규 `tests/core/reporting_cli/test_report_card_news_svg_prompt.py`.
