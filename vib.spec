...
hidden_imports = [
    ...
    "vibelign.commands.vib_backup_db_maintenance_cmd","vibelign.commands.vib_backup_graph_summary_cmd",
    "vibelign.commands.vib_bench_cmd","vibelign.commands.vib_checkpoint_cmd",
