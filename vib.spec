...
hidden_imports = [
    ...
    "vibelign.core.local_checkpoints","vibelign.core.meta_paths","vibelign.core.patch_suggester",
    "vibelign.core.project_map","vibelign.core.project_scan","vibelign.core.protected_files",
    "vibelign.core.risk_analyzer","vibelign.core.scan_cache","vibelign.core.secret_scan",
